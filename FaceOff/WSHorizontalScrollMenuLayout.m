//
//  WSHorizontalScrollMenuLayout.m
//  UITest
//
...
#import "WSHorizontalScrollMenuLayout.h"
...
@interface WSHorizontalScrollMenuLayout ()

@property (strong, nonatomic) NSMutableDictionary * layoutInfo;

@end

@implementation WSHorizontalScrollMenuLayout
...
- (void)setupDefaults {
    ...
    self.itemSize = CGSizeMake(40.0f, 40.0f);
